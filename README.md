...
!Schema of GEMA (relative/path/to/GEMMA.jpg?raw=true "GEMMA")

![alt text](https://github.com/GiovanniGranato/
Flexible-goal-directed-behaviour-and-representations-learning/blob/master/GEMMA.jpg?raw=true)
